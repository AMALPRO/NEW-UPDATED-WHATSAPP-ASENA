...
const array = ['Hii','ee','Da','food','Hlo','para','love u','set','sed','jada','amal','Hi','sad','don','Thoma','Adhi','Pepe','Loki','bye']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
